...
// }
          ...
          title: RichText(
              ...
              text: TextSpan(
                  ...
                  children: [
                    TextSpan(
                      text:
                          'Silahkan isi judul dan pilih tanggal terlebih dahulu.\n',
                      style: TextStyle(
                          fontSize: 16,
  ...
  void _updateFormValidity() {
    setState(() {
      isFormValid =
          _titleController.text.isNotEmpty && _dateController.text.isNotEmpty;
    });
  }
  ...
  void initState() {
    ...
    if (widget.note != null) {
      ...
      _dateController = TextEditingController(
          text: DateFormat('EEEE, d MMMM yyyy, h:mm a', 'id_ID')
              .format(widget.note!.selectedDate));
    }
              ...
              onPressed: canProceed()
                  ? () {
                      ...
                      final snackBar = SnackBar(
                        content: Text(
                            'Pengingat untuk catatan ${_titleController.text} telah berhasil disimpan'),
                      );
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                      color: Color(0xFF293942).withOpacity(0.5), fontSize: 36),
                  ...
                  enabledBorder: UnderlineInputBorder(
                    borderSide:
                        BorderSide(color: Color(0xFF3D7F67), width: 2.0),
                  ),
                ),
              ),
              SizedBox(height: 50),
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                      color: Color(0xFF293942).withOpacity(0.5), fontSize: 16),
                  focusedBorder: UnderlineInputBorder(
                    borderSide: BorderSide(
                      color: Color(0xFF3D7F67),
                      width: 2.0,
                ...
                onTap: () async {
                  ...
                  if (pickedDate != null) {
                    ...
                    if (pickedTime != null) {
                      ...
                      setState(() {
                        _dateController.text =
                            DateFormat('EEEE, d MMMM yyyy, h:mm a', 'id_ID')
                      ...
                      scheduleReminderNotification(
                          pickedDateTime.subtract(Duration(minutes: 30)),
                          _titleController.text);
                    }
                  }
                },
              ...
              TextField(
                ...
                style: TextStyle(
                    ...
                    fontSize: 14),
                decoration: InputDecoration(
                  hintText: 'Notifikasi akan menyala 30 menit sebelumnya',
                  hintStyle: TextStyle(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(30),
                    borderSide:
                        BorderSide(color: Color(0xFFD63636), width: 2.0),
                  ),
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(30),
                    borderSide:
                ...
                itemBuilder: (context, index) {
                  return Card(
                    ...
                    child: ListTile(
                      ...
                      titleTextStyle:
                          TextStyle(color: Color(0xFF3D7F67), fontSize: 16),
                      leading: Icon(
                        Icons.article,
                        color: Color(0xFF3D7F67),
                      ),
                                    ...
                                    title: RichText(
                                      ...
                                      text: TextSpan(
                                          ...
                                          children: [
                                            TextSpan(
                                              text:
                                                  'File tidak bisa dikembalikan lagi.\n',
                                              style: TextStyle(
                                                  fontSize: 16,
                                                  fontWeight: FontWeight.normal,
                                                  color: Color(0xFF293942),
