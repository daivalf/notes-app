    ...
    if (result != null) {
      setState(() {
        ...
        widget.notes[originalIndex] = Note(
          ...
          modifiedTime: DateTime.now(),
          selectedDate:
              DateFormat('EEEE, d MMMM yyyy, h:mm a', 'id_ID').parse(result[2]),
        );
      });
    }
  }
          ...
          return AlertDialog(
              ...
              title: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: TextStyle(
                      color: Color(0xFF293942).withOpacity(0.5), fontSize: 24),
                ),
              ),
              content: Row(
                          ...
                          return Card(
                            ...
                            child: Padding(
                              ...
                              child: ListTile(
                                ...
                                leading: IconButton(
                                  onPressed: () {
                                    setState(() {
                                      ...
                                      filteredNotes[index].isCompleted =
                                          !filteredNotes[index].isCompleted;
                                      // move to the bottom
                                ...
                                trailing: IconButton(
                                    onPressed: () async {
                                      final result = await deleteConfirmation(
                                          context, index);
